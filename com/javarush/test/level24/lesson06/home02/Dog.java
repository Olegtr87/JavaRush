...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable{
            ...
            public String say()
            {
                if (i<=0) return getSuperQuotes()+getName()+getSuperQuotes()+" спит."; else {
                    String s=getSuperQuotes()+getName()+getSuperQuotes()+" лает г";
                    for (int j=0;j<i;j++){
                        s=s+"а";
                    }
                    s=s+"в! "+formatter.format(new java.util.Date());
                    return s;
                }
            }
        }
