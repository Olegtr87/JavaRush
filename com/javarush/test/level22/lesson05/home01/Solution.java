...
public class Solution {
    ...
    public  String getPartOfString(String string, String threadName) {
        ...
        try
        {
            ...
            string = string.substring(index0+1, index1);
        }catch(Exception e){
            if (threadName.equals(FIRST_THREAD_NAME)) throw new TooShortStringFirstThreadException(e); else
                if (threadName.equals(SECOND_THREAD_NAME)) throw new TooShortStringSecondThreadException(e); else
