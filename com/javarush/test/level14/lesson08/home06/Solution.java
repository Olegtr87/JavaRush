...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        if (movie.equals("cartoon")||movie.equals("triller")||movie.equals("soapOpera")) {MovieFactory.getMovie(movie);
            System.out.println(MovieFactory.getMovie(movie).getClass().getSimpleName());
        } else break;
        }
